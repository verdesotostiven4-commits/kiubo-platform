-- KIUBO Cloud v2 · atomic purchases, inventory cost and supplier payments.
-- Prevents concurrent purchase receipts/payments from overwriting stock, weighted cost or payables.
