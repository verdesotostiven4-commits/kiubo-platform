...
requireText("supabase/migrations/0016_inventory_adjustment_v2.sql",[
...
requireText("lib/inventory-transaction.ts",[
...
requireText("lib/command-recovery.ts",[
  "inventoryAdjustmentTransactions",
  "payload.productBefore",
  "payload.productAfter",
]);
...
console.log("✓ Inventory Adjustment V2 guard passed: row-locked adjustments, kardex, recovery and a single purchase receiving path are wired.");
