...
console.log("✓ Pilot Readiness V10 passed: all coupled money/stock commands are atomic-only, payment retries are idempotent, and offline/role/branch guards remain enforced.");
