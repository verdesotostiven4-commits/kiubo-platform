/* Hakuna 10.10.3 — forward-only panel z-index + touch fix + deterministic search router. */
...
(()=>{
  const path=location.pathname,v='10.10.3',logo=window.KIUBO_CATALOG_CONFIG.brandLogoUrl;
