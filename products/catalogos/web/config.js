/* Hakuna 10.17.0 — intuitive delivery map, push notifications and provider workflow. */
...
(()=>{
  const path=location.pathname,v='10.17.0',logo=window.KIUBO_CATALOG_CONFIG.brandLogoUrl;
