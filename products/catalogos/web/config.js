/* Hakuna 10.17.1 — center-pin delivery map, push notifications and provider workflow. */
...
(()=>{
  const path=location.pathname,v='10.17.1',logo=window.KIUBO_CATALOG_CONFIG.brandLogoUrl;
