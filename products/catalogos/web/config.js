/* Hakuna 10.16.8 — fluid brands + preserved product-detail background. */
...
(()=>{
  const path=location.pathname,v='10.16.8',logo=window.KIUBO_CATALOG_CONFIG.brandLogoUrl;
