/* Hakuna 10.10.8 — forward-only panel fixes + public catalog image prewarm. */
...
(()=>{
  const path=location.pathname,v='10.10.8',logo=window.KIUBO_CATALOG_CONFIG.brandLogoUrl;
  ...
  if(/^\/(panel|master)(?:\/|$)/.test(path)){
    ...
    /* Start warming Home/brand/product imagery before the catalog runtime mounts. */
    document.write(`<script src="/catalog-v10.10.8.js?v=${v}"><\/script>`);
  }
})();
