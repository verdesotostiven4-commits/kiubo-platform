/* Hakuna 10.17.2 — center-pin map with live device location, push notifications and provider workflow. */
...
(()=>{
  const path=location.pathname,v='10.17.2',logo=window.KIUBO_CATALOG_CONFIG.brandLogoUrl;
