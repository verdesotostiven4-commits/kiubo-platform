/* Hakuna 10.10.5 — deterministic search routing + fresh cache generation. */
...
(()=>{
  const path=location.pathname,v='10.10.5',logo=window.KIUBO_CATALOG_CONFIG.brandLogoUrl;
