/* Hakuna 10.8.2 — sticky save footer + photo autosave. */
...
(()=>{
  const path=location.pathname,v='10.8.2',logo=window.KIUBO_CATALOG_CONFIG.brandLogoUrl;
  ...
  if(/^\/(panel|master)(?:\/|$)/.test(path)){
    ...
    [
      ...
      '/panel-v10-stability.css','/panel-v10.4.2.css','/panel-v10.5.css','/panel-v10.5.1.css','/panel-v10.6.css','/panel-v10.8.css'
    ].forEach(addStyle);
    ...
    const scripts=[
      ...
      '/panel-v10-stability.js','/panel-v10.5.js','/panel-v10.5.1.js','/panel-v10.6.js','/panel-v10.8.js','/push-v10.7.js'
    ];
