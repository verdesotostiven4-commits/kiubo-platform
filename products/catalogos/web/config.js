/* Hakuna 10.10.9 — image prewarm + brand handoff + discoverable cart. */
...
(()=>{
  const path=location.pathname,v='10.10.9',logo=window.KIUBO_CATALOG_CONFIG.brandLogoUrl;
  ...
  if(/^\/(panel|master)(?:\/|$)/.test(path)){
    ...
    [
      ...
      '/panel-v10-stability.css','/panel-v10.4.2.css','/panel-v10.5.css','/panel-v10.5.1.css','/panel-v10.6.css','/panel-v10.9.css','/panel-v10.10.css'
    ].forEach(addStyle);
    ...
    const scripts=[
      ...
      '/panel-v10-stability.js','/panel-v10.5.1.js','/panel-v10.6.js','/panel-v10.9.js','/panel-v10.10.js','/push-v10.7.js'
    ];
    ...
    addStyle('/catalog-v10.10.9.css');
    /* Start warming imagery, then install small UX enhancements before catalog runtime mounts. */
    document.write(`<script src="/catalog-v10.10.8.js?v=${v}"><\/script><script src="/catalog-v10.10.9.js?v=${v}"><\/script>`);
  }
})();
