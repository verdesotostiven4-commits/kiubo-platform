/* Hakuna 10.9.0 — forward-only stabilization release. */
...
(()=>{
  const path=location.pathname,v='10.9.0',logo=window.KIUBO_CATALOG_CONFIG.brandLogoUrl;
  ...
  if(/^\/(panel|master)(?:\/|$)/.test(path)){
    ...
    const scripts=[
      ...
      '/panel-v10-stability.js','/panel-v10.5.js','/panel-v10.5.1.js','/panel-v10.6.js','/panel-v10.9.js','/push-v10.7.js'
    ];
