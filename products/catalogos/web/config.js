/* Hakuna 10.16 — corrected mobile catalog detail/cart + inventory/order safety panel 10.15. */
...
(()=>{
  const path=location.pathname,v='10.16.0',logo=window.KIUBO_CATALOG_CONFIG.brandLogoUrl;
