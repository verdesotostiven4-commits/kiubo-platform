/* Hakuna 10.16.5 — stable search, seamless brands and reciprocal catalog filters. */
...
(()=>{
  const path=location.pathname,v='10.16.5',logo=window.KIUBO_CATALOG_CONFIG.brandLogoUrl;
