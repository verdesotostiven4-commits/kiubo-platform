/* Hakuna 10.16.1 — final catalog/mobile polish + inventory/order safety panel 10.15. */
...
(()=>{
  const path=location.pathname,v='10.16.1',logo=window.KIUBO_CATALOG_CONFIG.brandLogoUrl;
  ...
  if(/^\/(panel|master)(?:\/|$)/.test(path)){
    ...
    [
      ...
      '/panel-v10-stability.css','/panel-v10.4.2.css','/panel-v10.5.css','/panel-v10.5.1.css','/panel-v10.6.css','/panel-v10.9.css','/panel-v10.10.css','/panel-v10.11.css','/panel-v10.14.css','/panel-v10.15.css'
    ].forEach(addStyle);
    ...
    const scripts=[
      ...
      '/panel-v10-stability.js','/panel-v10.5.1.js','/panel-v10.6.js','/panel-v10.9.js','/panel-v10.10.js','/panel-v10.11-core.js','/panel-v10.11-ui.js','/panel-v10.14.js','/panel-v10.15.js','/push-v10.7.js'
    ];
    ...
    document.write(`<script src="/catalog-v10.12.js?v=${v}"><\/script><script src="/catalog-v10.13.js?v=${v}"><\/script><script src="/catalog-v10.11.js?v=${v}"><\/script><script src="/catalog-v10.16.1.js?v=${v}"><\/script>`);
  }
})();
