/* Hakuna 10.9.2 — guarded Web Push copy sync; never self-triggers the DOM observer. */
(()=>{'use strict';
if(window.__hakunaPush1092)return;window.__hakunaPush1092=true;
...
function refreshCopy(){setCopy('.hm1051-notify-card small','Te avisaremos de cambios del pedido incluso si cierras Hakuna.');setCopy('.hm1051-panel-notify small','Mayra recibirá avisos de pedidos nuevos incluso con el panel cerrado.')}
let copyFrame=0;const scheduleCopy=()=>{if(copyFrame)return;copyFrame=requestAnimationFrame(()=>{copyFrame=0;refreshCopy()})};
