/* Hakuna Matata Catalog 10.6.2 — checkout persistence, retry-safe orders and final mobile cleanup. */
(()=>{
'use strict';
if(window.__hakunaCatalog1062)return;window.__hakunaCatalog1062=true;
...
function enhance(){bindCheckoutDraft();polishCartBadges();document.documentElement.dataset.hmCatalog='10.6.2'}
