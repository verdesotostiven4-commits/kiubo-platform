...
export function MobileNav(){
  ...
  const visible=candidates
    .filter(item=>canAccess(user.role,item.permission,Boolean(user.platformAdmin)))
    .filter(item=>platformPath?item.platformOnly:(!item.platformOnly||user.platformAdmin))
