...
export function ReportsClient(){
  ...
  const canReverse=Boolean(ctx.user?.platformAdmin||ctx.user?.role==="owner"||ctx.user?.role==="admin"||ctx.user?.role==="cashier");
