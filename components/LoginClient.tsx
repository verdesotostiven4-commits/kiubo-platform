...
export function LoginClient(){
  ...
  const submit=async(e:FormEvent<HTMLFormElement>)=>{
    ...
    const result=await getAuthProvider().signIn(cloud?{email,password:String(f.get("password")||"")}:{email,pin:String(f.get("pin")||"")});
    setBusy(false);
