...
export function ReceiptClient(){
  ...
  return <main className="receipt-page"><style>{`
    ...
    *{box-sizing:border-box}
    ...
    .totals{display:grid;gap:1.4mm;font-size:9px}.totals .grand{font-size:17px;font-weight:950;border-top:1.5px solid #111;padding-top:1.8mm;margin-top:.5mm}.totals .grand span:last-child{font-size:19px}.payment{font-weight:850}
  ...
  `}</style><section className="receipt">
    ...
    <div className="rule"/><section className="totals"><div className="row"><span>Subtotal</span><b>{money(subtotal)}</b></div><div className="row payment"><span>Forma de pago</span><b>{paymentLabel[sale.payment]}</b></div><div className="row grand"><span>TOTAL</span><span>{money(sale.total)}</span></div></section>
