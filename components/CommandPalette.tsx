...
const entries:Entry[]=[
  ...
  {href:"/orders",label:"Pedidos",description:"Pedidos del negocio",glyph:"≡",permission:"pos",feature:"pos",keywords:"pedidos cocina local llevar domicilio"},
