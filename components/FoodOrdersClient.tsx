...
export function FoodOrdersClient(){
  ...
  const changeStatus=(order:FoodOrderRecord,status:FoodOrderStatus)=>{
    ...
    saveLocalDatabase(next);refresh();setMessage(`Pedido #${String(order.number).padStart(4,"0")} actualizado.`);
  };
